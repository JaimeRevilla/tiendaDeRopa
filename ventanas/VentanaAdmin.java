...
public class VentanaAdmin extends JFrame {
	...
	public VentanaAdmin(JFrame va) {
		...
		btnAniadir = new JButton("A�ADIR PRODUCTO");
		...
		JOptionPane.showMessageDialog(null, "PARA BORRAR UN PRODUCTO PULSE EL RAT�N SOBRE EL CODIGO DE LOS PRODUCTO EN LA TABLA 3 VECES", "ADVERTENCIA!!!", JOptionPane.NO_OPTION);
